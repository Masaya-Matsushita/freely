...
export const Notes = () => {
  ...
  return (
    <div className='mx-4 space-y-4 rounded-md bg-white py-8 px-4 shadow-sm shadow-dark-100 xxs:mx-6 xs:mx-auto xs:w-[550px] xs:space-y-3 sm:space-y-5 md:w-[650px] md:px-8 md:py-14'>
      {NOTES.map((note) => {
        return (
