  ...
  return (
    <>
      <div className='flex items-center justify-center gap-2 pt-20 xs:pt-24'>
        ...
        <div className='text-2xl font-bold tracking-wider text-dark-500 xxs:text-3xl xs:text-4xl'>
          プラン作成
        </div>
      </div>
      <hr className='mt-5 h-[3px] w-28 rounded-sm border-0 bg-main-400 xxs:w-36 xs:mt-7 xs:h-1 xs:w-44 md:mt-8' />
      <Paper
        shadow='xs'
        radius='lg'
        p='md'
